...
//       } else {
//         setFile(null);
//         setUploadStatus('Please upload a Word document (.doc or .docx)');
//       }
//     }
//   };
...
//       const response = await axios.post('http://your.personal.ip:port/endpoint', {
//         docx: base64String,
//         filename: file.name
//       });
...
//   return (
//     <div className={styles.container}>
//       <h2 className={styles.title}>Document Upload and Processing</h2>
...
//         <label htmlFor="fileInput" className={styles.fileInputLabel}>
//           <Upload className={styles.uploadIcon} />
//           <span>Choose a Word document</span>
//         </label>
//         {file && <p className={styles.fileName}>{file.name}</p>}
//       </div>
